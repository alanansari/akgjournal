...
export default function Home() {
  return (
    <div className={` ${openSans.className} min-h-full`}>
      <Navbar page='archive' />
      <div className='w-[100vw] pt-[7rem] flex flex-col items-center border-y-2 border-black'>
        <div className='text-center flex flex-col justify-center items-center '>
          ...
          <div className={` w-full py-2 text-[#08090C]`}>Here’s what people of our collage have published over the years.</div>
        </div>
