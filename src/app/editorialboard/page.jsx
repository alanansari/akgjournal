  ...
  return (
    <div className={openSans.className}>
      ...
      <div className="pt-[7rem] md:pt-[10rem] flex flex-col items-center justify-center mb-10 px-4">
          <h1 className={`${clash_Display.className} font-semibold text-2xl xs:text-3xl mb-2 sm:text-5xl sm:mb-6 leading-normal text-center`}>Editorial Advisory Board</h1>
